<template>
  <Layout>
    ...
    <div> <!-- Overview -->
      ...
      <h2>Who is funding this program? How much has been pledged?</h2>
      <p>
    ...
    <div> <!-- Grants process -->
      ...
      <h1>ETC Grants Process</h1>

      <p>
Grant Process
Call for proposals 🡪 Grant Application submission 🡪 Evaluation/Technical review 🡪 Grants team approval 🡪 Formal agreement & Due diligence (KYC/KYB) 🡪 Milestone reviews & payments 🡪 Project Launch & Project retrospective analysis.
...
Milestone reviews and project launch will be done on a project by project basis. It should be outlined in the application, when milestones and deliverables are expected. This part of the grant process will run concurrently, with the launch of subsequent grant rounds. (No defined timeline - each project will have a different timeline). 
...
Project funding required is more than maximum grants for that grant category and type.
